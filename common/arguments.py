...
def get_args():
    ...
    # Environment
    parser.add_argument("--max_episodes", type=int, default=500, help="number of episodes ")
    ...
    # memory buffer
    parser.add_argument("--buffer_size", type=int, default=int(50000),    # DDPG: 1e4 for 200 ep,  3e4 for 500 ep
